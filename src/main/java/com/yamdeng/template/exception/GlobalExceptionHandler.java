...
public class GlobalExceptionHandler {
    ...
    public ExceptionDto handleMethodArgumentNotValidException(HttpServletRequest request, MethodArgumentNotValidException ex) {
        log.error("handleMethodArgumentNotValidException : " + ex);
        ReqeustParameterException reqeustParameterException = new ReqeustParameterException(ex.getAllErrors());
        return new ExceptionDto(ex.getMessage(), ex.toString(), reqeustParameterException.getErrorObjects());
    }
