...
public interface Constant {
    ...
    static final String CODE_WORK_RESULT_SUCCESS_BIRTHDAY = "SUCCESS_BIRTHDAY"; /* 연차 */
    ...
    static final String CODE_WORK_RESULT_VACATION_CARE = "VACATION_CARE"; /* 유악휴직 */
    ...
    static final String CODE_VACATION_KIND_VACATION_REPLACE = "VACATION_REPLACE"; /* 포상휴가 */
    ...
    static final String CODE_VACATION_KIND_VACATION_CARE = "VACATION_CARE"; /* ETC */
    static final String CODE_VACATION_KIND_ETC = "ETC"; /* 기타 */
